...
- **Tools/Env**: Linux (Bash scripting, terminal workflows), Jupyter, Git/GitHub, Discord for collab
- **ML/AI Focus**: Neural Networks, Predictive Modeling, Numerical Optimization, GPU/Parallel Computing (exploring)
- **Other**: Data Automation, Algorithmic Efficiency, Mathematical Modeling, Full Stack Engineering 
